...
urlpatterns = [
    ...
    path('books/<int:id>/chapters/', views.book_chapters, name='book_chapters'), # For rendering book metadata views (according to original tutorials)
    path('books/<int:id>/new_chapter/', views.new_chapter, name='new_chapter'), # For rendering new book metadata views recieving inputs (according to original tutorials)
